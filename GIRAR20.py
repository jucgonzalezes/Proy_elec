...
def rot(Motor,Sentido, step_count):
	GPIO.output(eval('DIR{}'.format(Motor)),Sentido) # Activa el puerto del motor: Motor y le da la direccion: Sentido
...
with open('puntos_iniciales.dat','r') as f:
	coord_inicial=f.read().splitlines()
